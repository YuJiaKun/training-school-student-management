...
const ERROR_TEXT_MAP = {
  ...
  'class has active students': '班级下仍有在读学生，请先转班或归档',
  'class has active homework assignments': '班级下仍有未删除作业任务，请先删除任务',
  ...
  'schedule time is in the past': '不能预约已经过去的时间',
  'invalid schedule slot': '预约时间必须按 30 分钟对齐',
  'schedule duration too long': '单次预约最长 2 小时',
  'invalid student learning stage': '学生学习阶段无效',
  'student not eligible for scheduling': '当前学生不处于求职中，暂不能申请面试排期',
  'target class forbidden': '不能移动到未负责的班级',
